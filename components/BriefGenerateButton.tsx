...
export default function BriefGenerateButton({ briefPlatformId, postsCount, contentItems, contentType }: Props) {
  ...
  const needsMedia     = hasMedia && postsNeeded === 0 && mediaNoneItems.length > 0
