...
export default function BriefGenerateButton({ briefPlatformId, hasContent, contentId }: Props) {
        ...
        {open && (
          <div className="absolute right-0 top-full mt-1 w-44 bg-white border border-gray-200 rounded-lg shadow-lg z-10 py-1 text-sm">
            ...
            >
              ...
              {loading === 'content-only' ? 'Generating...' : 'Content only'}
            </button>
            ...
            {hasContent && contentId && (
              ...
              >
                ...
                {loading === 'retry-media' ? 'Starting...' : 'Retry media only'}
              </button>
            )}
          </div>
        )}
